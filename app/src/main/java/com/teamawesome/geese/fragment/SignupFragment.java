...
public class SignupFragment extends Fragment {
    ...
    private void setupSignupButton(View view) {
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Send request to server with username/password/email and perform callback for success or failure
    ...
    private void setupFacebookLogin(View view) {
        ...
        facebookLoginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                // App code
                loginUser("hello", "world@mail.com");
            }
    ...
    private void loginUser(String user, String email) {
